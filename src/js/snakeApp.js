...
function control(e) {
    ...
    if(e.keyCode === 39){
        direction = 1 //if we press right arrow on our keyboard, the class of snake from all the squares.
    }else if (e.keyCode === 38){
        direction = -width //if we press the up arrow, the snake will go back ten divs, appearing to go up.
    }else if(e.keyCode === 37) {
        direction -1 //if we press left, the snake will go left one div.
    }else if (e.keyCode === 40 ) {
        direction = +width //if we press down, the snake head will appear in the div from where you are now
    }
